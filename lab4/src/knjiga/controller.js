...
const getBooksForDownload = (req, res) => {
    pool.query(queries.getBooks, (error, results) => {
        ...
        fs.writeFile("C:/Users/Korisnik/Desktop/outputJSON.json", content, 'utf8', function(err) {
            if(err) {
                console.log("Error!");
    ...
    pool.query(queries.getBooks, (error, results) => {
        ...
        converter.json2csv(obj, (err, csv) => {
            ...
            fs.writeFile("C:/Users/Korisnik/Desktop/outputCSV.csv", csv, 'utf8', function(err) {
                if(err) {
                    console.log("Error!");
                    return console.log(err);
                }
